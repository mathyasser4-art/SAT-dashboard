...
const UpdateQuestion = () => {
    ...
    const handleUpadteQuestion = () => {
        if (
            ...
            (mcqAnswerFr === '' && questionType === 'MCQ') ||
            (mcqAnswerFs === '' && questionType === 'MCQ') ||
            (mcqAnswerSe === '' && questionType === 'MCQ') ||
            (mcqAnswerTh === '' && questionType === 'MCQ')
        ) {
            setserverOperationError('Enter the question data first!')
        } else {
            const data = new FormData()
            if (questionPic) data.append('image', questionPic)
    ...
    const uploadAnswerPic = () => {
        ...
        // Correct API signature + refetch to update displayed answerPic
        addAnswerPic(data, questionDetails._id, setserverOperationError, setServerLoadingPic, setQuesionFullAdded)
            .then(() => {
                getQuestion()
            })
    }
    ...
    return (
        <div className="update-question">
            <div>
                ...
                {(previewQuestionPic) ? (
                    <img className='preview-img' src={previewQuestionPic} alt="" />
                ) : (questionDetails.questionPic) ? (
                ...
                {(questionType == 'Essay') ? (
                    ...
                    <div className="keyboard mcq-answer d-flex">
                        <div className='mcq-input'>
                            <div className='d-flex align-items-center answer-toggel'>
                                <input
                                    ...
                                    value={mcqAnswerFs}
                                    name="coorect-answer"
                                    onChange={e => checkedCorrecrAnswer(e.target.value)}
                                />
                ...
                <div className="d-flex">
                    ...
                    <Link to={`/chapter/${questionTypeName}/${questionDetails.chapter}/${questionTypeID}/${unitID}/${subjectID}`}>
                ...
                {(previewAnswerPic) ? (
                    <img className='preview-img' src={previewAnswerPic} alt="" />
                ) : (questionDetails.answerPic) ? (
                    <div className='question-pic'>
                ...
                <div className="d-flex">
                    <button className='button answer-button' onClick={uploadAnswerPic}>
                        {(serverLoadingPic) ? <span className="button-loader"></span> : 'Update'}
                    </button>
                </div>
            </div>
        </div>
